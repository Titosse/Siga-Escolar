...
function TeacherGrades() {
  ...
  function calcularMedia(student) {
    const media =
      (student.av1 + student.av2 + student.trabalho + student.exame) / 4;
        ...
        <div className="bg-white rounded-3xl shadow-sm p-6 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-slate-500 mt-1">
              Registo e acompanhamento das avaliações da turma
            </p>
          </div>
                      ...
                      >
                        ...
                        <td className="py-4 px-4">
                          <input
                            ...
                            value={student.av1}
                            onChange={(e) =>
                              handleChange(student.id, "av1", e.target.value)
                            }
                        ...
                        <td className="py-4 px-4">
                          <input
                            ...
                            value={student.av2}
                            onChange={(e) =>
                              handleChange(student.id, "av2", e.target.value)
                            }
                            className="w-20 border border-slate-300 rounded-xl px-3 py-2 outline-none focus:ring-2 focus:ring-slate-400"
                          />
                        </td>
